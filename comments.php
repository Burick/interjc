...
<?php if ( have_comments() ) : ?>
	...
	<?php foreach ($comments as $comment) : ?>
		...
		<li class="comment_li <?php global $comment; if ($comment->comment_author_email == get_the_author_email()) echo 'author_comment';?>" id="comment-<?php comment_ID() ?>">
			...
			<strong class="commentmetadata"><?php comment_author_link() ?></strong><span class="commentmetadata"><a href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('Y.m.d') ?> <?php comment_time() ?></a> <?php edit_comment_link('e','',''); ?><?php if ($comment->comment_approved == '0') : ?><em>您的评论正在等待审核.</em><?php endif; ?></span>
