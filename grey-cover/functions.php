...
//function simg
function greycover_get_simg(){
	$simg = get_post_meta(get_the_ID(), 'simg', true);
	if ($simg){ ?>

<p class="slider-simg" style="background:url(<?php echo $simg; ?>) no-repeat left top;"></p>
<?php
	}					
}
//以下内嵌了第三方插件：
...
function CategoryPosts() {
	parent::WP_Widget(false, $name='分类 Widget');
}
/**
